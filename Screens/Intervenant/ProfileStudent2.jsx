...
const ProfileStudent2 = ({route, sidebarRef}) => {
    const { 
        isCopilotActive, 
    } = useCopilot();    
    const { t } = useTranslation();
    const {theme} = useTheme();
    const { data, dataOfAssiduite } = route.params;
    ...
    return (
        ...
        <View style={styles.header}>
            <TouchableOpacity 
                onPress={() =>{
                    pushToHistory("AssiduiteSingle", { data : dataOfAssiduite });
                    navigation.navigate("AssiduiteSingle", { data : dataOfAssiduite });
                }}
                style={[
...
export default ProfileStudent2;
