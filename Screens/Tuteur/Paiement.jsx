...
const Paiement = () => {
  ...
  useEffect(() => {
    ...
    Animated.timing(topHeight, {
      toValue: (selectedFees.length > 0 ) ? 75 : 0,    
      duration: 500,                              
      useNativeDriver: false                         
    }).start();
  }, [selectedFees.length]);
          ...
          >
            ...
            <View style={{
            ...
            }} >
              {
                ...
                />
                :
                <View style={[styles.selectorButton, {borderColor : theme === "light" ? "gainsboro" : "rgb(61, 61, 61)"} ,{backgroundColor : theme === "light" ? "white" : "#282828"}]} >
                  <Text style={[styles.selectorText, {
                    color : theme === "light" ? "#141414" : "white"
                    }]}
                  >
                    Fils sélectionné : {selectedSon && selectedSon.nom}
                  </Text>
                </View>
