            ...
            >
                {
                    ...
                    <>
                        <View style={styles.cardOfCalendar} >
                            <TouchableOpacity
                                style={[styles.inputOfTimeFIlter]}
                            >
                                <Text
                                    style={{
                                ...
                                >
                                    12 Février - 09 Juillet
                                </Text>
                                <View
                                    style={[styles.inputOfCalendar,{
                                        backgroundColor : theme === "light" ? "white" : "#282828"
                                    }]}
                                >
                                    <Octicons name="calendar" size={18} color={theme === "light" ? "#141414" : "white"}  />
                                </View>
                            </TouchableOpacity>
                        </View>
                ...
                <View style={[styles.cardOfCalendar2, { flexDirection : "column" ,height : "auto", marginTop : 13, borderRadius : 9} , {backgroundColor : theme === "light" ? "white" : "#282828"}]}>
                    <View
                        style={{
                            marginTop : 17,
                            width : "100%", 
