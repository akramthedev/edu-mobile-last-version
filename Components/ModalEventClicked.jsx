...
const ModalEventClicked = ({ eventClicked,seteventClicked, showModal, setShowModal, theme }) => {
        ...
        <TouchableWithoutFeedback onPress={() => setShowModal(false)}>
            ...
            <TouchableWithoutFeedback>
                <View style={[styles.modalView, {backgroundColor : theme === "light" ? "white" : "rgb(40, 40, 40)"}, {borderWidth : 1}, {borderColor : theme === "light" ? "white" : "rgb(59, 59, 59)"}]}>
                    ...
                    <TouchableOpacity style={[styles.buttonClose, {borderTopColor : theme === "light" ? "rgb(224, 224, 224)" : "rgb(72, 72, 72)"}]} onPress={() => {setShowModal(false);setTimeout(()=>{seteventClicked(null);}, 500)}}>
...
export default ModalEventClicked;