...
const ModalChoixFiliere = ({ modalVisible, setModalVisible, theme }) => {
          ...
          <TouchableWithoutFeedback>
            <View style={[styles.modalView, {backgroundColor : theme === "light" ? "white" : "#141414"},{borderWidth : theme === "light" ? 0 : 1}, {borderColor : theme === "light" ? "gray" : "rgb(67, 67, 67)"}]}>
              <Text style={[styles.modalTextTitlte, { color : theme === "light" ? "#141414" : "#E3E3E3" }]}>
                ...
                &nbsp;&nbsp;Nouvelle année, nouvelle filière !
              </Text>
              <Text style={[styles.modalText2, { color : theme === "light" ? "#141414" : "#E3E3E3" }]}>
                Les inscriptions sont désormais ouvertes ! Sélectionnez votre filière pour l’année académique à venir et assurez votre place dès maintenant.
              </Text>
              <TouchableOpacity style={styles.buttonClose} onPress={() => {setModalVisible(false);pushToHistory("ModalChoixFiliere");navigation.navigate("ModalChoixFiliere")}}>
